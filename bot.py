...
heroku_conn = heroku3.from_key(keyy)
app = heroku_conn.apps()[appp]
...
def start(message):
    ...
    res = types.InlineKeyboardButton(text='ReBoot Bot ♻', callback_data='restart')
    markup_inline.row_width = 2
    markup_inline.add(start, make, file, delete, donefilee, deletedone, sid, emt, res)
